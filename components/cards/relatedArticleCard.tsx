...
export default function RelatedArticleCard({content}) {
  return (
    <Link href={content.url}>
      <a className={styles.card}>
        ...
        <div className={styles.imageSection}>
          {content.thumbnails.map(function(url){
            return <img className={styles.image} src={url}></img>;
          })}
        </div>
        <h4>
          {content.title}
